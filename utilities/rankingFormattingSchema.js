...
const RANKING_FORMATTING_SCHEMA = {
  ...
  headerRow: 5,
  // Row immediately above headers contains a synthetic MEDIAN row in the exported rankings CSV.
  medianRow: 4,
  // Actual player data begins after the header row.
  dataStartRow: 6,
  ...
  conditionalFormattingStartRow: 6,
  notesColumn: 1,
