...
const WEIGHT_TEMPLATES = {
  ...
  TPC_SAWGRASS: {
    ...
    groupWeights: {
      "Driving Performance": 0.09296933183660581,
      "Approach - Short (<100)": 0.09568112430456223,
      "Approach - Mid (100-150)": 0.11535062552152404,
      "Approach - Long (150-200)": 0.10531255406703162,
      "Approach - Very Long (>200)": 0.05840265869870228,
      "Putting": 0.11401673535959692,
      "Around the Green": 0.06873541631676088,
      "Scoring": 0.19581640346433918,
      "Course Management": 0.15371515043087716
    },
    metricWeights: {
      "Driving Performance": {
        "Driving Distance": { weight: 0.24237521692085284 },
        "Driving Accuracy": { weight: 0.26105185761028166 },
        "SG OTT": { weight: 0.4965729254688655 }
      },
      "Approach - Short (<100)": {
        "Approach <100 GIR": { weight: 0.3730040177268823 },
        "Approach <100 SG": { weight: 0.3049009072621895 },
        "Approach <100 Prox": { weight: 0.3220950750109282 }
      },
      "Approach - Mid (100-150)": {
        "Approach <150 FW GIR": { weight: 0.10087694220755003 },
        "Approach <150 FW SG": { weight: 0.18033420266781605 },
        "Approach <150 FW Prox": { weight: 0.23219339167843334 },
        "Approach <150 Rough GIR": { weight: 0.11386879849006694 },
        "Approach <150 Rough SG": { weight: 0.17125551530639313 },
        "Approach <150 Rough Prox": { weight: 0.20147114964974064 }
      },
      "Approach - Long (150-200)": {
        "Approach <200 FW GIR": { weight: 0.12244115939388665 },
        "Approach <200 FW SG": { weight: 0.18528654427286215 },
        "Approach <200 FW Prox": { weight: 0.227896284536616 },
        "Approach >150 Rough GIR": { weight: 0.10631165192480362 },
        "Approach >150 Rough SG": { weight: 0.1565828369752312 },
        "Approach >150 Rough Prox": { weight: 0.20148152289660032 }
      },
      "Approach - Very Long (>200)": {
        "Approach >200 FW GIR": { weight: 0.2420394232794304 },
        "Approach >200 FW SG": { weight: 0.30495714936800133 },
        "Approach >200 FW Prox": { weight: 0.45300342735256827 }
      },
      "Putting": {
        "SG Putting": { weight: 1 }
      },
      ...
      "Scoring": {
        "SG T2G": { weight: 0.5835732349287179 },
        "Scoring Average": { weight: 0.12101027549038665 },
        "Birdie Chances Created": { weight: 0.07653030198477904 },
        "Scoring: Approach <100 SG": { weight: 0.02254527732239998 },
        "Scoring: Approach <150 FW SG": { weight: 0.033489586702205795 },
        "Scoring: Approach <150 Rough SG": { weight: 0.033489586702205795 },
        "Scoring: Approach <200 FW SG": { weight: 0.06697917340441159 },
        "Scoring: Approach >200 FW SG": { weight: 0.031191281732446573 },
        "Scoring: Approach >150 Rough SG": { weight: 0.031191281732446573 }
      },
      "Course Management": {
        "Scrambling": { weight: 0.3531482507913145 },
        "Great Shots": { weight: 0.25330644314601625 },
        "Poor Shot Avoidance": { weight: 0.1594280109133001 },
        "Course Management: Approach <100 Prox": { weight: 0.024114081400385002 },
        "Course Management: Approach <150 FW Prox": { weight: 0.03581994615785345 },
        "Course Management: Approach <150 Rough Prox": { weight: 0.03581994615785345 },
        "Course Management: Approach >150 Rough Prox": { weight: 0.033361714558785074 },
        "Course Management: Approach <200 FW Prox": { weight: 0.0716398923157069 },
        "Course Management: Approach >200 FW Prox": { weight: 0.033361714558785074 }
      }
    }
  },
  TPC_LOUISIANA: {
