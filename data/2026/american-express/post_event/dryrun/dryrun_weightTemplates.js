...
const WEIGHT_TEMPLATES = {
  ...
  TECHNICAL: {
    ...
    groupWeights: {
      "Driving Performance": 0.055396641915322974,
      "Approach - Short (<100)": 0.06065711878685762,
      "Approach - Mid (100-150)": 0.12656491839893422,
      "Approach - Long (150-200)": 0.16250661233126312,
      "Approach - Very Long (>200)": 0.06136243412158853,
      "Putting": 0.06366450500577968,
      "Around the Green": 0.0401344017554515,
      "Scoring": 0.23756391920220998,
      "Course Management": 0.19214944848259244
    },
    metricWeights: {
      "Driving Performance": {
        "Driving Distance": { weight: 0.3995 },
        "Driving Accuracy": { weight: 0.1089 },
        "SG OTT": { weight: 0.4916 }
      },
      "Approach - Short (<100)": {
        "Approach <100 GIR": { weight: 0.5092 },
        "Approach <100 SG": { weight: 0.2165 },
        "Approach <100 Prox": { weight: 0.2743 }
      },
      "Approach - Mid (100-150)": {
        "Approach <150 FW GIR": { weight: 0.21062106210621062 },
        "Approach <150 FW SG": { weight: 0.1465146514651465 },
        "Approach <150 FW Prox": { weight: 0.0965096509650965 },
        "Approach <150 Rough GIR": { weight: 0.21662166216621662 },
        "Approach <150 Rough SG": { weight: 0.16651665166516652 },
        "Approach <150 Rough Prox": { weight: 0.16321632163216324 }
      },
      "Approach - Long (150-200)": {
        "Approach <200 FW GIR": { weight: 0.1941 },
        "Approach <200 FW SG": { weight: 0.1396 },
        "Approach <200 FW Prox": { weight: 0.0618 },
        "Approach >150 Rough GIR": { weight: 0.2451 },
        "Approach >150 Rough SG": { weight: 0.1892 },
        "Approach >150 Rough Prox": { weight: 0.1702 }
      },
      "Approach - Very Long (>200)": {
        "Approach >200 FW GIR": { weight: 0.393 },
        "Approach >200 FW SG": { weight: 0.3719 },
        "Approach >200 FW Prox": { weight: 0.2351 }
      },
      "Putting": {
        "SG Putting": { weight: 1 }
      },
      ...
      "Scoring": {
        "SG T2G": { weight: 0.2801 },
        "Scoring Average": { weight: 0.1422 },
        "Birdie Chances Created": { weight: 0.1436 },
        "Scoring: Approach <100 SG": { weight: 0.0816 },
        "Scoring: Approach <150 FW SG": { weight: 0.0805 },
        "Scoring: Approach <150 Rough SG": { weight: 0.0322 },
        "Scoring: Approach <200 FW SG": { weight: 0.0044 },
        "Scoring: Approach >200 FW SG": { weight: 0.1163 },
        "Scoring: Approach >150 Rough SG": { weight: 0.1191 }
      },
      "Course Management": {
        "Scrambling": { weight: 0.1615 },
        "Great Shots": { weight: 0.0173 },
        "Poor Shot Avoidance": { weight: 0.19075031454959174 },
        "Course Management: Approach <100 Prox": { weight: 0.0772 },
        "Course Management: Approach <150 FW Prox": { weight: 0.0856 },
        "Course Management: Approach <150 Rough Prox": { weight: 0.1732 },
        "Course Management: Approach >150 Rough Prox": { weight: 0.1175 },
        "Course Management: Approach <200 FW Prox": { weight: 0.1395 },
        "Course Management: Approach >200 FW Prox": { weight: 0.1046 }
      }
    }
  }, 
  BALANCED: {
  ...
  PETE_DYE_STADIUM_COURSE: {
    ...
    eventId: "2",
    description: "The American Express 2026 Optimized: 0.8342 corr, 65.0% Top-20, 73.8% Top-20 Weighted",
    groupWeights: {
      "Driving Performance": 0.15196764180851222,
      "Approach - Short (<100)": 0.0391212968787799,
      "Approach - Mid (100-150)": 0.09489357892920644,
      "Approach - Long (150-200)": 0.09058915040400722,
      "Approach - Very Long (>200)": 0.05135174586861619,
      "Putting": 0.11059611872201289,
      "Around the Green": 0.04808250611722296,
      "Scoring": 0.20667746932890468,
      "Course Management": 0.2067204919427376
    },
    metricWeights: {
      "Driving Performance": {
        "Driving Distance": { weight: 0.29894765548198104 },
        "Driving Accuracy": { weight: 0.28642821882649455 },
        "SG OTT": { weight: 0.41462412569152446 }
      },
      "Approach - Short (<100)": {
        "Approach <100 GIR": { weight: 0.13355075018059945 },
        "Approach <100 SG": { weight: 0.08038674089328396 },
        "Approach <100 Prox": { weight: -0.7860625089261166 }
      },
      "Approach - Mid (100-150)": {
        "Approach <150 FW GIR": { weight: 0.09937619285065007 },
        "Approach <150 FW SG": { weight: 0.2128062749264589 },
        "Approach <150 FW Prox": { weight: 0.6875292606460469 },
        "Approach <150 Rough GIR": { weight: 0.00009609052561472753 },
        "Approach <150 Rough SG": { weight: 0.00009609052561472753 },
        "Approach <150 Rough Prox": { weight: -0.00009609052561472753 }
      },
      "Approach - Long (150-200)": {
        "Approach <200 FW GIR": { weight: 0.11968654031999622 },
        "Approach <200 FW SG": { weight: 0.34324929018351846 },
        "Approach <200 FW Prox": { weight: 0.5367527065678892 },
        "Approach >150 Rough GIR": { weight: 0.00010382097619870203 },
        "Approach >150 Rough SG": { weight: 0.00010382097619870203 },
        "Approach >150 Rough Prox": { weight: -0.00010382097619870203 }
      },
      "Approach - Very Long (>200)": {
        "Approach >200 FW GIR": { weight: 0.11420661005468219 },
        "Approach >200 FW SG": { weight: 0.16480526681621738 },
        "Approach >200 FW Prox": { weight: -0.7209881231291004 }
      },
      "Putting": {
        "SG Putting": { weight: 1 }
      },
      ...
      "Scoring": {
        "SG T2G": { weight: 0.7415387476211699 },
        "Scoring Average": { weight: 0.007247944077873178 },
        "Birdie Chances Created": { weight: 0.12012424910720917 },
        "Scoring: Approach <100 SG": { weight: 0.008704509338219365 },
        "Scoring: Approach <150 FW SG": { weight: 0.018124734127652316 },
        "Scoring: Approach <150 Rough SG": { weight: 0.019694107770043084 },
        "Scoring: Approach <200 FW SG": { weight: 0.054530800321079036 },
        "Scoring: Approach >200 FW SG": { weight: 0.016590768306922153 },
        "Scoring: Approach >150 Rough SG": { weight: 0.013444139329831949 }
      },
      "Course Management": {
        "Scrambling": { weight: 0.3744675603762353 },
        "Great Shots": { weight: 0.08505297829681345 },
        "Poor Shot Avoidance": { weight: 0.20652438287192043 },
        "Course Management: Approach <100 Prox": { weight: -0.029466437822671318 },
        "Course Management: Approach <150 FW Prox": { weight: 0.07628454748000683 },
        "Course Management: Approach <150 Rough Prox": { weight: -0.058406443237816484 },
        "Course Management: Approach >150 Rough Prox": { weight: -0.05191558821565493 },
        "Course Management: Approach <200 FW Prox": { weight: 0.20150389131339674 },
        "Course Management: Approach >200 FW Prox": { weight: -0.05199118261988175 }
      }
    }
  }};
