...
const WEIGHT_TEMPLATES = {
  ...
  TECHNICAL: {
    ...
    groupWeights: {
      "Driving Performance": 0.2681259144442352,
      "Approach - Short (<100)": 0.046095232576668456,
      "Approach - Mid (100-150)": 0.08232533209717374,
      "Approach - Long (150-200)": 0.12611725166953977,
      "Approach - Very Long (>200)": 0.04138720285089308,
      "Putting": 0.03838855007170692,
      "Around the Green": 0.014616621517868786,
      "Scoring": 0.22229143428314813,
      "Course Management": 0.16065246048876597
    },
    metricWeights: {
      "Driving Performance": {
        "Driving Distance": { weight: 0.4446 },
        "Driving Accuracy": { weight: 0.4116 },
        "SG OTT": { weight: 0.1438 }
      },
      "Approach - Short (<100)": {
        "Approach <100 GIR": { weight: 0.5788 },
        "Approach <100 SG": { weight: 0.2686 },
        "Approach <100 Prox": { weight: 0.1526 }
      },
      "Approach - Mid (100-150)": {
        "Approach <150 FW GIR": { weight: 0.286971302869713 },
        "Approach <150 FW SG": { weight: 0.18088191180881913 },
        "Approach <150 FW Prox": { weight: 0.022797720227977204 },
        "Approach <150 Rough GIR": { weight: 0.26877312268773124 },
        "Approach <150 Rough SG": { weight: 0.2117788221177882 },
        "Approach <150 Rough Prox": { weight: 0.0287971202879712 }
      },
      "Approach - Long (150-200)": {
        "Approach <200 FW GIR": { weight: 0.28927107289271076 },
        "Approach <200 FW SG": { weight: 0.19148085191480851 },
        "Approach <200 FW Prox": { weight: 0.0893910608939106 },
        "Approach >150 Rough GIR": { weight: 0.1725827417258274 },
        "Approach >150 Rough SG": { weight: 0.09019098090190981 },
        "Approach >150 Rough Prox": { weight: 0.1670832916708329 }
      },
      "Approach - Very Long (>200)": {
        "Approach >200 FW GIR": { weight: 0.0503 },
        "Approach >200 FW SG": { weight: 0.1412 },
        "Approach >200 FW Prox": { weight: 0.8085 }
      },
      "Putting": {
        "SG Putting": { weight: 1 }
      },
      ...
      "Scoring": {
        "SG T2G": { weight: 0.3026302630263026 },
        "Scoring Average": { weight: 0.24462446244624464 },
        "Birdie Chances Created": { weight: 0.1455145514551455 },
        "Scoring: Approach <100 SG": { weight: 0.06560656065606561 },
        "Scoring: Approach <150 FW SG": { weight: 0.05500550055005501 },
        "Scoring: Approach <150 Rough SG": { weight: 0.054205420542054204 },
        "Scoring: Approach <200 FW SG": { weight: 0.012201220122012201 },
        "Scoring: Approach >200 FW SG": { weight: 0.043404340434043405 },
        "Scoring: Approach >150 Rough SG": { weight: 0.0768076807680768 }
      },
      "Course Management": {
        "Scrambling": { weight: 0.22222222222222227 },
        "Great Shots": { weight: 0.14021402140214023 },
        "Poor Shot Avoidance": { weight: 0.4202732668448213 },
        "Course Management: Approach <100 Prox": { weight: 0.007400740074007402 },
        "Course Management: Approach <150 FW Prox": { weight: 0.0023002300230023005 },
        "Course Management: Approach <150 Rough Prox": { weight: 0.034303430343034305 },
        "Course Management: Approach >150 Rough Prox": { weight: 0.17961796179617964 },
        "Course Management: Approach <200 FW Prox": { weight: 0.10671067106710673 },
        "Course Management: Approach >200 FW Prox": { weight: 0.07770777077707772 }
      }
    }
  }, 
  BALANCED: {
  ...
  PETE_DYE_STADIUM_COURSE: {
    ...
    eventId: "2",
    description: "The American Express 2026 Pre-Event Blended",
    groupWeights: {
      "Driving Performance": 0.07913495161602041,
      "Approach - Short (<100)": 0.07501136194399975,
      "Approach - Mid (100-150)": 0.12551494582083478,
      "Approach - Long (150-200)": 0.13925217353052566,
      "Approach - Very Long (>200)": 0.04594988056427732,
      "Putting": 0.09194999047404956,
      "Around the Green": 0.05533521565081724,
      "Scoring": 0.21353326667421224,
      "Course Management": 0.17431821372526307
    },
    metricWeights: {
      "Driving Performance": {
        "Driving Distance": { weight: 0.332215605792244 },
        "Driving Accuracy": { weight: 0.11888481693417369 },
        "SG OTT": { weight: 0.5488995772735823 }
      },
      "Approach - Short (<100)": {
        "Approach <100 GIR": { weight: 0.35351999999999995 },
        "Approach <100 SG": { weight: 0.2659 },
        "Approach <100 Prox": { weight: 0.38058000000000003 }
      },
      "Approach - Mid (100-150)": {
        "Approach <150 FW GIR": { weight: 0.11883759804551881 },
        "Approach <150 FW SG": { weight: 0.14850627919934847 },
        "Approach <150 FW Prox": { weight: 0.21278985041361273 },
        "Approach <150 Rough GIR": { weight: 0.1214092837855214 },
        "Approach <150 Rough SG": { weight: 0.15707856499935707 },
        "Approach <150 Rough Prox": { weight: 0.24137842355664135 }
      },
      "Approach - Long (150-200)": {
        "Approach <200 FW GIR": { weight: 0.1089 },
        "Approach <200 FW SG": { weight: 0.13982857142857144 },
        "Approach <200 FW Prox": { weight: 0.2064857142857143 },
        "Approach >150 Rough GIR": { weight: 0.13075714285714288 },
        "Approach >150 Rough SG": { weight: 0.1610857142857143 },
        "Approach >150 Rough Prox": { weight: 0.25294285714285714 }
      },
      "Approach - Very Long (>200)": {
        "Approach >200 FW GIR": { weight: 0.2718 },
        "Approach >200 FW SG": { weight: 0.31914 },
        "Approach >200 FW Prox": { weight: 0.40906 }
      },
      "Putting": {
        "SG Putting": { weight: 1 }
      },
      ...
      "Scoring": {
        "SG T2G": { weight: 0.4703001847804015 },
        "Scoring Average": { weight: 0.18307981521959865 },
        "Birdie Chances Created": { weight: 0.08616 },
        "Scoring: Approach <100 SG": { weight: 0.04011084 },
        "Scoring: Approach <150 FW SG": { weight: 0.03294819 },
        "Scoring: Approach <150 Rough SG": { weight: 0.03294819 },
        "Scoring: Approach <200 FW SG": { weight: 0.07631478 },
        "Scoring: Approach >200 FW SG": { weight: 0.039069 },
        "Scoring: Approach >150 Rough SG": { weight: 0.039069 }
      },
      "Course Management": {
        "Scrambling": { weight: 0.23213031225731645 },
        "Great Shots": { weight: 0.178721680607612 },
        "Poor Shot Avoidance": { weight: 0.15934434328885455 },
        "Course Management: Approach <100 Prox": { weight: 0.06618976423231743 },
        "Course Management: Approach <150 FW Prox": { weight: 0.054370163476546454 },
        "Course Management: Approach <150 Rough Prox": { weight: 0.054370163476546454 },
        "Course Management: Approach >150 Rough Prox": { weight: 0.06447054957693256 },
        "Course Management: Approach <200 FW Prox": { weight: 0.1259324735069416 },
        "Course Management: Approach >200 FW Prox": { weight: 0.06447054957693256 }
      }
    }
  }};
