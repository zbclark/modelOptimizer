...
const WEIGHT_TEMPLATES = {
  ...
  PETE_DYE_STADIUM_COURSE: {
    ...
    groupWeights: {
      "Driving Performance": 0.07913495161601986,
      "Approach - Short (<100)": 0.07501136194399975,
      "Approach - Mid (100-150)": 0.12551494582083478,
      "Approach - Long (150-200)": 0.13925217353052569,
      "Approach - Very Long (>200)": 0.045949880564277325,
      "Putting": 0.09194999047404927,
      "Around the Green": 0.05533521565081715,
      "Scoring": 0.21353326667421235,
      "Course Management": 0.17431821372526396
    },
    metricWeights: {
      "Driving Performance": {
        "Driving Distance": { weight: 0.33221560579224396 },
        "Driving Accuracy": { weight: 0.11888481693417371 },
      ...
      "Scoring": {
        "SG T2G": { weight: 0.47030018478040175 },
        "Scoring Average": { weight: 0.18307981521959832 },
        "Birdie Chances Created": { weight: 0.08616000000000001 },
      ...
      "Course Management": {
        "Scrambling": { weight: 0.23213031225731331 },
        "Great Shots": { weight: 0.17872168060761548 },
        "Poor Shot Avoidance": { weight: 0.15934434328885416 },
