...
const WEIGHT_TEMPLATES = {
  ...
  PEBBLE_BEACH_GOLF_LINKS: {
    ...
    groupWeights: {
      "Driving Performance": 0.17614189232671004,
      "Approach - Short (<100)": 0.040318893923616504,
      "Approach - Mid (100-150)": 0.0902532573220938,
      "Approach - Long (150-200)": 0.12912527372994334,
      "Approach - Very Long (>200)": 0.043303790845907415,
      "Putting": 0.0892094465927753,
      "Around the Green": 0.03414956022552166,
      "Scoring": 0.23358860588342606,
      "Course Management": 0.163909279150006
    },
    metricWeights: {
      "Driving Performance": {
        "Driving Distance": { weight: 0.34946042683539374 },
        "Driving Accuracy": { weight: 0.3572287631836992 },
        "SG OTT": { weight: 0.29331080998090703 }
      },
      "Approach - Short (<100)": {
        "Approach <100 GIR": { weight: 0.644035596440356 },
        "Approach <100 SG": { weight: 0.2873712628737126 },
      ...
      "Approach - Long (150-200)": {
        "Approach <200 FW GIR": { weight: 0.24279999999999996 },
        "Approach <200 FW SG": { weight: 0.1662 },
        "Approach <200 FW Prox": { weight: 0.0759 },
        "Approach >150 Rough GIR": { weight: 0.20799999999999996 },
        "Approach >150 Rough SG": { weight: 0.1385 },
        "Approach >150 Rough Prox": { weight: 0.1686 }
      },
      "Approach - Very Long (>200)": {
        "Approach >200 FW GIR": { weight: 0.19071907190719073 },
        "Approach >200 FW SG": { weight: 0.27502750275027504 },
      ...
      "Scoring": {
        "SG T2G": { weight: 0.4046358104942072 },
        "Scoring Average": { weight: 0.2906241895057929 },
      ...
      "Course Management": {
        "Scrambling": { weight: 0.30768692328655683 },
        "Great Shots": { weight: 0.14259309154081887 },
        "Poor Shot Avoidance": { weight: -0.20451940600560264 },
        "Course Management: Approach <100 Prox": { weight: 0.03931355247256789 },
        "Course Management: Approach <150 FW Prox": { weight: 0.056556338644746795 },
        "Course Management: Approach <150 Rough Prox": { weight: 0.056556338644746795 },
        "Course Management: Approach >150 Rough Prox": { weight: 0.04672795052660482 },
        "Course Management: Approach <200 FW Prox": { weight: 0.09931844835175045 },
        "Course Management: Approach >200 FW Prox": { weight: 0.04672795052660482 }
      }
    }
  },
