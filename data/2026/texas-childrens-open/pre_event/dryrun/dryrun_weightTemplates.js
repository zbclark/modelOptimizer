...
const WEIGHT_TEMPLATES = {
  ...
  MEMORIAL_PARK_GOLF_COURSE: {
    ...
    groupWeights: {
      "Driving Performance": 0.09489350592736259,
      "Approach - Short (<100)": 0.04014388921988314,
      "Approach - Mid (100-150)": 0.11901346494080534,
      "Approach - Long (150-200)": 0.1565345507139666,
      "Approach - Very Long (>200)": 0.13430809512534497,
      "Putting": 0.11962305931514616,
      "Around the Green": 0.08795129710965488,
      "Scoring": 0.12783735691959142,
      "Course Management": 0.11969478072824496
    },
    metricWeights: {
      "Driving Performance": {
        "Driving Distance": { weight: 0.2010847700956006 },
        "Driving Accuracy": { weight: 0.21628021309134 },
        "SG OTT": { weight: 0.5826350168130595 }
      },
      "Approach - Short (<100)": {
        "Approach <100 GIR": { weight: 0.6904 },
        "Approach <100 SG": { weight: 0.1188 },
        "Approach <100 Prox": { weight: -0.1908 }
      },
      "Approach - Mid (100-150)": {
      ...
      "Scoring": {
        "SG T2G": { weight: 0.6150847351179585 },
        "Scoring Average": { weight: 0.1329152648820417 },
        "Birdie Chances Created": { weight: 0.036000000000000004 },
        "Scoring: Approach <100 SG": { weight: 0.012528000000000006 },
        "Scoring: Approach <150 FW SG": { weight: 0.029376000000000013 },
        "Scoring: Approach <150 Rough SG": { weight: 0.029376000000000013 },
        "Scoring: Approach <200 FW SG": { weight: 0.07884000000000002 },
        "Scoring: Approach >200 FW SG": { weight: 0.03294000000000001 },
        "Scoring: Approach >150 Rough SG": { weight: 0.03294000000000001 }
      },
      "Course Management": {
        "Scrambling": { weight: 0.29348506944885516 },
        "Great Shots": { weight: 0.21457786657139838 },
        "Poor Shot Avoidance": { weight: 0.18749447067790898 },
        "Course Management: Approach <100 Prox": { weight: -0.017657670411506572 },
        "Course Management: Approach <150 FW Prox": { weight: -0.04140419268904989 },
        "Course Management: Approach <150 Rough Prox": { weight: 0.04140419268904989 },
        "Course Management: Approach >150 Rough Prox": { weight: 0.04642749547853021 },
        "Course Management: Approach <200 FW Prox": { weight: -0.11112154655517066 },
        "Course Management: Approach >200 FW Prox": { weight: -0.04642749547853021 }
      }
    }
  }
};
