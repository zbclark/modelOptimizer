...
const WEIGHT_TEMPLATES = {
  ...
  PGA_NATIONAL_RESORT_CHAMPION_COURSE: {
    ...
    groupWeights: {
      "Driving Performance": 0.16672665252069582,
      "Approach - Short (<100)": 0.04036583684654667,
      "Approach - Mid (100-150)": 0.08789139007612023,
      "Approach - Long (150-200)": 0.0951165561048691,
      "Approach - Very Long (>200)": 0.05158597201475214,
      "Putting": 0.11831216173280967,
      "Around the Green": 0.05756294130486371,
      "Scoring": 0.2520902932815373,
      "Course Management": 0.13034819611780546
    },
    metricWeights: {
      "Driving Performance": {
        "Driving Distance": { weight: 0.26438724331263697 },
        "Driving Accuracy": { weight: 0.24766668627430738 },
        "SG OTT": { weight: 0.4879460704130557 }
      },
      "Approach - Short (<100)": {
        "Approach <100 GIR": { weight: 0.3880937734498066 },
        "Approach <100 SG": { weight: 0.21038512673635973 },
        "Approach <100 Prox": { weight: 0.4015210998138336 }
      },
      "Approach - Mid (100-150)": {
        "Approach <150 FW GIR": { weight: 0.14910589775442276 },
        "Approach <150 FW SG": { weight: 0.20812720813968147 },
        "Approach <150 FW Prox": { weight: 0.3404571250827982 },
        "Approach <150 Rough GIR": { weight: 0.13372662733726629 },
        "Approach <150 Rough SG": { weight: 0.12766723327667234 },
        "Approach <150 Rough Prox": { weight: 0.04091590840915909 }
      },
      "Approach - Long (150-200)": {
        "Approach <200 FW GIR": { weight: 0.16918139898907553 },
        "Approach <200 FW SG": { weight: 0.27467408120006526 },
        "Approach <200 FW Prox": { weight: 0.2827245198108593 },
        "Approach >150 Rough GIR": { weight: 0.12468000000000001 },
        "Approach >150 Rough SG": { weight: 0.11286 },
        "Approach >150 Rough Prox": { weight: 0.03588 }
      },
      "Approach - Very Long (>200)": {
        "Approach >200 FW GIR": { weight: 0.24895632691404415 },
        "Approach >200 FW SG": { weight: 0.2871569751056835 },
        "Approach >200 FW Prox": { weight: 0.46388669798027243 }
      },
      "Putting": {
        "SG Putting": { weight: 1 }
      },
      ...
      "Scoring": {
        "SG T2G": { weight: 0.5297599501066639 },
        "Scoring Average": { weight: 0.16793028087023845 },
        "Birdie Chances Created": { weight: 0.0746925307469253 },
        "Scoring: Approach <100 SG": { weight: 0.01502273772622738 },
        "Scoring: Approach <150 FW SG": { weight: 0.03254926507349265 },
        "Scoring: Approach <150 Rough SG": { weight: 0.03254926507349265 },
        "Scoring: Approach <200 FW SG": { weight: 0.0930954504549545 },
        "Scoring: Approach >200 FW SG": { weight: 0.027200259974002598 },
        "Scoring: Approach >150 Rough SG": { weight: 0.027200259974002598 }
      },
      "Course Management": {
        "Scrambling": { weight: 0.3895166244939703 },
        "Great Shots": { weight: 0.2033223988424298 },
        "Poor Shot Avoidance": { weight: 0.17180654368800347 },
        "Course Management: Approach <100 Prox": { weight: 0.015533392576389365 },
        "Course Management: Approach <150 FW Prox": { weight: 0.033655683915510284 },
        "Course Management: Approach <150 Rough Prox": { weight: 0.033655683915510284 },
        "Course Management: Approach >150 Rough Prox": { weight: 0.02812485474058377 },
        "Course Management: Approach <200 FW Prox": { weight: 0.09625996308701892 },
        "Course Management: Approach >200 FW Prox": { weight: 0.02812485474058377 }
      }
    }
  },
  TECHNICAL: {
